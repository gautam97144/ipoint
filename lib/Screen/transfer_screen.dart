...
import 'package:ipoint/Screen/transfer_confirm_screen.dart';
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(children: [
                                Text(
                                  'Points available for transfer is upto:',
                                  style: TextStyle(
                                      fontSize: 14,
                                    ...
                                    child: SlideAction(
                                      ...
                                      onSubmit: () {
                                        if (pointController.text != "" &&
                                          ...
                                          CustomToast.toast(
                                              "Enter ipoint and referral code");
                                        }
